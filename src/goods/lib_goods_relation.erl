...
merge_goods_default(GoodsStatus, PlayerStatus) ->
    ...
    %NullCellsList = lists:seq(Num1, PlayerStatus#player_status.cell_num),
    %NullCellsMap = lib_goods_util:update_null_cell(NewStatus#goods_status.null_cells, ?GOODS_LOC_BAG, NullCellsList),
    %NewGoodsStatus = NewStatus#goods_status{null_cells = NullCellsMap},
